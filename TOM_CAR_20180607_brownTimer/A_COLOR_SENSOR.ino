...
int color_filter(int r, int g, int b, int c) {
  ...
  if (_workstart) {
    ...
    if (color_condition != 6) {//不是黑色
      if (R_G >= 1.95 && R_G <= 3.2 && R_B > 1.68 && R_B <= 2.6 && g < (b + 50)) {
        //Serial.println("**** RED ****");
        color_condition = 1;
      } else if (R_G >= 0.85 && R_G <= 1.25 && R_B >= 1.20 && R_B <= 1.4 && g > r && g > b) {
        //Serial.println("**** Green ****");
        color_condition = 2;
      } else if (R_G >= 1.00 && R_G <= 1.35 && R_B >= 0.25 && R_B <= 0.9) {
        //Serial.println("**** BLUE ****");
        color_condition = 3;
    ...
    //1Serial.print("R_G :"); Serial.println(R_G);
