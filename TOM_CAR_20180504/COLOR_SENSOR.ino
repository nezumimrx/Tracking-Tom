...
void GET_COLOR() {
  ...
  int CD = color_filter(int(red), int(green), int(blue), int(Clear));//1-RED,2-GREEN,3-BLUE,4-YELLOW,5-BROWN
}
...
int color_filter(int r, int g, int b, int c) {
  ...
  if (_workstart) {
    ...
    if (R_G >= 2.15 && R_G <= 2.55 && R_B >= 1.8 && R_B <= 2.1) {
      //Serial.println("**** RED ****");
      color_condition = 1;
    } else if (R_G >= 0.95 && R_G <= 1.15 && R_B >= 1.25 && R_B <= 1.35) {
      //Serial.println("**** Green ****");
      color_condition = 2;
    } else if (R_G >= 1.05 && R_G <= 1.25 && R_B >= 0.5 && R_B <= 0.65) {
      //Serial.println("**** BLUE ****");
      color_condition = 3;
    } else if (R_G >= 2.60 && R_G <= 3.6 && R_B >= 2.6 && R_B <= 4.25) {
      //Serial.println("**** YELLOW ****");
      color_condition = 4;
    } else if (R_G >= 1.58 && R_G <= 1.8 && R_B >= 1.35 && R_B <= 1.55) {
