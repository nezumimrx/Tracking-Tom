...
int color_filter(int r, int g, int b, int c) {
  ...
  if (_workstart) {
    ...
    if (color_condition != 6) {//不是黑色
      if (R_G >= 1.95 && R_G <= 2.55 && R_B > 1.68 && R_B <= 2.1) {
        //Serial.println("**** RED ****");
        color_condition = 1;
      } else if (R_G >= 0.85 && R_G <= 1.1 && R_B >= 1.20 && R_B <= 1.35) {
        //Serial.println("**** Green ****");
        color_condition = 2;
      } else if (R_G >= 1.00 && R_G <= 1.3 && R_B >= 0.25 && R_B <= 0.7) {
        //Serial.println("**** BLUE ****");
        color_condition = 3;
      } else if (R_G >= 2.20 && R_G <= 4.8 && R_B >= 2.20 && R_B <= 6.8) {
        //Serial.println("**** YELLOW ****");
        color_condition = 4;
      } else if (R_G >= 1.40 && R_G <= 1.8 && R_B >= 1.25 && R_B <= 1.65&&r>g) {
